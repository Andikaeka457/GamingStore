    ...
    <body style="background-color: #393C8B">
      <nav class="navbar navbar-expand-lg " style="background-color: #14164A">
        ...
        <div class="container text-center">
          <br><br>
            <h3 class="text-light">Order Finish</h3>
            <br>
            <img src="pic/cv1.jpg" style="width: 800px">
            <br> <br>
            <p class="text-light">We will inform you via email <br>
              once the transaction has been <br>
              accepted</p>
              <button type="button" class="btn btn-primary text-light" >&emsp; &emsp; &emsp; &emsp; &emsp; &emsp;  Cancel &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; </button>
        </div>
        <br><br><br> <br><br>
